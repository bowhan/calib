...
void extract_barcodes_and_minimizers() {
    ...
    while (true) {
        ...
        s1_length -= ignored_sequence_prefix_length_1;
        s2_length -= ignored_sequence_prefix_length_2;
        ...
        if (s1_seg_length >= kmer_size) {
            int start = barcode_length_1 + ignored_sequence_prefix_length_1;
        ...
        if (s2_seg_length >= kmer_size) {
            int start = barcode_length_2 + ignored_sequence_prefix_length_2;
